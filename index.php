...
<body oncontextmenu="return false" oncopy="return false" oncut="return false">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/auth/register">
                            <div style="padding-left: 5px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px; border-radius: 5px;" class="button btn-danger">
                                Daftar Sekarang
                            </div>
                        </a>
                    </li>
    ...
    <div class="jumbotron text-center md" id="home">
        <img class="justify-content-center img-fluid" style="width: 800px" src="./assets/img/jumbotron.webp"
            alt="main-image">
    ...
    <section id="keunggulan">
        <div class="container">
            ...
            <div class="row justify-content-center text-center">
                <h2 class="text-primary mb-3">Di Gunakan Oleh
                    <?php echo $total_user?> Orang
                </h2>
                <h2 class="text-primary">Menyelesaikan Hingga
                    <?php echo $total_order?> Transaksi
                </h2>
            </div>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
